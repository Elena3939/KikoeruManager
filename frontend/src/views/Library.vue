...
function libraryRowClassName ({ row }) {
  ...
  if (libraryRowContextMenu.value.visible && libraryRowContextMenu.value.row?.path && row?.path === libraryRowContextMenu.value.row.path) return 'library-row-context-active'
